        ...
        return (
            <Jumbotron fluid style={{
                ...
                <Container>
                    ...
                    <Row noGutters>
                        <Button variant="outline-light" className="mt-2 mr-2" href="mailto:yash.shah830@rutgers.edu">
                            <FontAwesomeIcon className="mr-2" icon={faEnvelope} />
                            Email
                        </Button>
                        <Button variant="outline-light" className="mt-2 mr-2" href="/files/resume.pdf">
                            <FontAwesomeIcon className="mr-2" icon={faFileAlt} />
                            Resume
                        </Button>
                        <Button variant="outline-light" className="mt-2 mr-2" href="https://github.com/shahhyash">
                            <FontAwesomeIcon className="mr-2" icon={faGithub} />
                            Github
                        </Button>
                        <Button variant="outline-light" className="mt-2" href="https://www.linkedin.com/in/shahhyash">
